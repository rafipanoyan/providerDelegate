...
public abstract class ProviderDelegate {
    ...
    /**
     * check if a notification must be sent through the ContentResolver. See {@link android.content.ContentResolver#notifyChange(Uri, ContentObserver)}
     *
     ...
     */
    public boolean mustSendNotification(Uri uri, Operation operation) {
        return true;
    }
}
